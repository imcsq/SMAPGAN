...
class SmapGANABLL1GradL1Model(BaseModel):
    """
    ...
    def l1_origin_plus_rgb_grad_plus_gradloss(self, fake, real):
        return torch.nn.L1Loss()(fake, real) + L1_rgb_grad_loss(fake, real)
    
    def l1_origin_plus_rgb_grad_plus_gradlossP(self, fake, real):
        return 10.*torch.nn.L1Loss()(fake, real) + L1_rgb_grad_loss(fake, real)
