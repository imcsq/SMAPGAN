...
class SmapGANABLL1Grad2Model(BaseModel):
    """
    ...
    def l1_origin_plus_rgb_grad_plus_gradloss(self, fake, real):
        return torch.nn.L1Loss()(fake, real) + grad_loss(fake, real) + grad_loss(fake.transpose(-1,-2), real.transpose(-1,-2))
    
    def l1_origin_plus_rgb_grad_plus_gradlossP(self, fake, real):
        return 10.*torch.nn.L1Loss()(fake, real) + grad_loss(fake, real) + grad_loss(fake.transpose(-1,-2), real.transpose(-1,-2))
